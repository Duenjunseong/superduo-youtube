...
from .views import (
    ...
    DownloadJobZipView, DownloadGroupZipView
)
...
urlpatterns = [
    ...
    path('groups/<uuid:group_id>/download-zip/', DownloadGroupZipView.as_view(), name='group_download_zip'), # 그룹 압축 다운로드
    ...
    path('job/<uuid:job_id>/download-zip/', DownloadJobZipView.as_view(), name='job_download_zip'), # 작업 압축 다운로드
